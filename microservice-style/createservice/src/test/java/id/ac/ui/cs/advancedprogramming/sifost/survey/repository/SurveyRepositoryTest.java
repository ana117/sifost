...
class SurveyRepositoryTest {
    ...
    void testSaveSurveyWithMultipleChoiceQuestion() {
        ...
        testAns.add("a");
        MultipleChoiceQuestion question = new MultipleChoiceQuestion(survey, "simple", testAns);
        survey.addQuestion(question);
    ...
    void testSaveSurveyWithMultipleQuestions() {
        ...
        List<String> testAns = new ArrayList<>();
        testAns.add("a");
        MultipleChoiceQuestion question2 = new MultipleChoiceQuestion(survey, "simple", testAns);
